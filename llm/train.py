...
model_id = "/home/gt/huggingface/Llama-2-7b-hf"
max_length = 768
device_map = "cuda:0"
batch_size = 32
micro_batch_size = 8
...
dataset = datasets.load_dataset(
    "/home/gt/code/git/llama2/tat_qa/", split='train'
)
...
model_save_path = '/home/gt/code/git/llama2/tatqa_train_full_output'
...
if IS_RESUME:
  ...
  trainer.train()
model.save_pretrained("llama-7b-base-int4-tatqa")
